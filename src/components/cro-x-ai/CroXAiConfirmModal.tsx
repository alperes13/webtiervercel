      ...
      {open && (
        <div className="fixed inset-0 z-[140] flex items-center justify-center px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md rounded-2xl border border-blue-500/40 bg-zinc-950/95 shadow-[0_0_40px_rgba(37,99,235,0.25)] p-6"
          >
            <button
              type="button"
              onClick={() => !submitting && onClose()}
            ...
            <div className="border-l-2 border-emerald-500 pl-3 space-y-1.5 text-[12px] text-white/90 leading-relaxed pr-6">
              {(() => {
            ...
            <div className="mt-5 text-center text-[13px] text-white/90 leading-relaxed">
            ...
            <div className="mt-5 flex items-center justify-center gap-3">
              <button
                ...
                className="px-6 py-2.5 rounded-full text-[12px] font-bold uppercase tracking-wider bg-emerald-500 hover:bg-emerald-400 text-white transition disabled:opacity-60 inline-flex items-center gap-2"
              >
              ...
              <button
                ...
                onClick={onEdit}
                disabled={submitting}
                className="px-6 py-2.5 rounded-full text-[12px] font-bold uppercase tracking-wider bg-orange-400 hover:bg-orange-300 text-zinc-900 transition disabled:opacity-60"
              >
                DÜZENLE
              </button>
            </div>
