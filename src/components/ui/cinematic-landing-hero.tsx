...
export function CinematicHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Webtier</span>, e-ticaret sitenizi ziyaretçiden müşteriye dönüştüren stratejik tasarım ve CRO optimizasyonu ile büyümenizi hızlandırır.
    </>
  ),
  metricValue = 248500,
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative w-screen h-screen overflow-hidden flex items-center justify-center bg-[#060c1a] text-white font-sans antialiased",
        className
      )}
    ...
    >
      ...
      {/* BACKGROUND: CTA (shown at end of scroll) */}
                      ...
                      <div className="space-y-2.5">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="h-2 w-20 bg-neutral-300 rounded-full mb-1.5 shadow-inner" />
