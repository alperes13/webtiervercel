    ...
    <div className="pricing-box-wrapper flex justify-center w-full">
      ...
      <div className="pricing-box-footer flex items-center justify-between mt-auto pt-4 border-t border-white/5 relative z-10">
        <div className="flex flex-col">
          <span className="text-[10px] text-zinc-400 font-bold mb-1 opacity-70">2 Kredi Hakkı.</span>
          <span className="text-xs text-zinc-500 uppercase tracking-wider font-semibold">Toplam Ücret</span>
        ...
        <Button
          onClick={onCtaClick}
          className={cn(
            "group/cta flex items-center justify-between gap-2 sm:gap-4 pl-4 sm:pl-8 pr-2 h-14 rounded-2xl text-sm sm:text-base font-bold text-black transition-all duration-300",
            "bg-gradient-to-r from-white to-zinc-200 hover:from-white hover:to-white",
            "shadow-[0_10px_30px_rgba(255,255,255,0.1)] hover:shadow-[0_10px_40px_rgba(255,255,255,0.2)]",
            "border-none"
          )}
        >
          <span className="tracking-tight">{ctaText}</span>
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-black text-white transition-transform duration-300 group-hover/cta:translate-x-0.5 group-hover/cta:-translate-y-0.5 shadow-lg">
