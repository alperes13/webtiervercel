      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            custom={{ x: -10, y: -10 }}
            className="pointer-events-none absolute left-[4px] top-[2px] hidden sm:block"
          >
          ...
          <motion.div
            ...
            variants={iconVariants}
            custom={{ x: 10, y: 10 }}
            className="pointer-events-none absolute bottom-[2px] left-[6rem] hidden sm:block"
          >
            <SettingsFilled className="text-[#005FF2] dark:text-[#006EFE]" />
          </motion.div>
          <div className="relative flex min-h-[35px] h-auto items-center justify-center p-2 sm:py-0 sm:px-3 rounded-[6px] border border-[#CBE7FF] bg-[#F0F7FF] text-sm dark:border-[#003674] dark:bg-[#06193A]">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-x-2 gap-y-1 text-center sm:text-left">
              <button
                className="focus-visible:shadow-focus-ring rounded-xs cursor-pointer border-none bg-transparent px-0 py-0.5 font-sans text-[13px] font-bold text-[#002359] underline decoration-[#CAE7FF] underline-offset-[5px] outline-none hover:text-[#005FF2] hover:decoration-[#94CCFF] focus-visible:!shadow-[#008FFF] dark:text-[#EAF5FF] dark:decoration-[#003674] dark:hover:text-[#44A7FF] dark:hover:decoration-[#00408A] whitespace-nowrap"
              ...
              <span className="text-[0.8125rem] text-[#005FF2] dark:text-[#44A7FF] leading-relaxed">
                {description}
              </span>
            </div>
            {onClose && (
              <button 
                onClick={onClose}
                className="ml-2 flex h-6 !w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-[#005FF2] hover:bg-[#CAE7FF] dark:hover:bg-[#012F61]"
              >
